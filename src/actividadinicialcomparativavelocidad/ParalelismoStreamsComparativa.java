...
public class ParalelismoStreamsComparativa {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("parallelStream : Con procesado paralelo QUE RÁPIDO " + (System.currentTimeMillis() - start) + "ms" + " APROVECHANDO LA POTENCIA DE MI PROCESADOR FORKJOINPOOL");
